...
% load('london_center_z20_model1.mat'); % load your own features
% load('test_route_1500.mat'); % run 'Generat_random_routes' to generate
% load('test_turn_1500.mat');
load('test_route_1500.mat');
load('test_turn_1500.mat');
