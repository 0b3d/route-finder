function [ways, inters] = parse_txt_nodes_for_roads(allNodesFile, inters)
% Parse nodes from ways.txt and intersections.txt
...
[~, Locb] = ismember(allNodesCoords, intersections, 'rows'); % Locb-location in B, ismember(A,B,'rows')
