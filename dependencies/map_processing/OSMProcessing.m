function [inters, buildings] = OSMProcessing(dataset, map_file)
...
%% Parse partial intersections and ways for localisation (delete some specific types of roads)
...
% Exract information about each natural (for visualization)
% allNaturalsFile = ['Data/',dataset,'/nature.txt'];
% [naturals] = parse_txt_nodes_for_naturals(allNaturalsFile);

% Exract information about each leisure (for visualization)
