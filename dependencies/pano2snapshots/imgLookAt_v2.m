function warped_im = imgLookAt_v2(im, CENTERx, CENTERy, new_imgH, new_imgShort, fov )
...
warped_im = zeros(new_imgShort,new_imgH,3);
[TXwarp, TYwarp] = meshgrid(1:new_imgH, 1:new_imgShort);

TX = TXwarp(:);                 TY = TYwarp(:);
TX = (TX -0.5 - new_imgH/2);    TY = (TY -0.5 - new_imgShort/2);
...
Px = reshape(Px, new_imgShort, new_imgH);
Py = reshape(Py, new_imgShort, new_imgH);
