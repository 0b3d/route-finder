function downloadGSV_v4(panoid, yaw, tiltyaw, tiltpitch, outfolder, outfolder_s, zoom, skip, img_num)
% download panoramas
if(~skip)
    tile_width = 512;
    tile_height = 512;
    ...
    imwrite(im,fullfile(outfolder,sprintf('%s.jpg',num2str(img_num))),'Quality',100);
    ...
    imwrite(destIm_fs,fullfile(outfolder_s,sprintf('%s_front.jpg',num2str(img_num))));
    imwrite(destIm_bs,fullfile(outfolder_s,sprintf('%s_back.jpg',num2str(img_num))));
    imwrite(destIm_rs,fullfile(outfolder_s,sprintf('%s_right.jpg',num2str(img_num))));
    imwrite(destIm_ls,fullfile(outfolder_s,sprintf('%s_left.jpg',num2str(img_num))));
end
