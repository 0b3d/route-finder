...
% Options
% ZatNrBQOlwIgEQQ3rJg2eA  MVB
% FkgEXZ_1fdvtZw8CHryixQ  BS2 8DA 
%seed_panoid = 'FkgEXZ_1fdvtZw8CHryixQ'; % random BRD panoid
% 51.518, -0.125
seed_panoid = 'GKa0zsVzHhLCt9L9_18T5w';
%seed_panoid = 'LA6AdOaofnLlLkIh78m_4g';


city = 'London';
outfolder = 'test';
download_number = 500; % number of panoramas you want to download
zoom = 3; % zoom: just zoom, not containing more parts!
...
neighborAll = true(1);  % 1 by 1 array of logical ones
