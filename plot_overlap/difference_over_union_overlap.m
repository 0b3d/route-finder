...
filename = fullfile('results_for_eccv', 'charts_network', ['difference_over_union_',params.turns,'_',params.top,'_',dataset,'_option_',num2str(option)]);
